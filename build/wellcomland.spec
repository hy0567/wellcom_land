...
"""
WellcomLAND PyInstaller Spec
빌드: python -m PyInstaller build/wellcomland.spec
출력: dist/WellcomLAND/ (onedir 모드)
...
project_path = Path(SPECPATH).parent  # ipkvm/
...
a = Analysis(
    ...
    datas=[
        ...
        (str(project_path / 'vision'), 'app/vision'),
